...
//>>>>>>>>> We use the find method because we want to find one element in the array based on a condition
...
// console.log(dogs.some(dog => dog.curFood > (dog.recFood * 0.90) && dog.curFood < (dog.recFood * 1.10))) Transforming in a function
const checkEatingOkay = dog => dog.curFood > dog.recFood * 0.90 && dog.curFood < dog.recFood * 1.10;
console.log(dogs.some(checkEatingOkay));

// 7. Create an array containing the dogs that are eating an okay amount of food (try to reuse the condition used in 6.)
const dogsEatingOkay = dogs.filter(dog => dog.curFood > (dog.recFood * 0.90) && dog.curFood < (dog.recFood * 1.10 ))
//using the function above console.log(dogs.filter(checkEatingOkay))
console.log(dogsEatingOkay);


// 8. Create a shallow copy of the 'dogs' array and sort it by recommended food portion in an ascending order (keep in mind that the portions are inside the array's objects 😉)

const dogsAsc = dogs.slice().sort((a,b) => a.recFood - b.recFood)
console.log(dogsAsc);
